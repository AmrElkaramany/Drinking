...
export default function RandomDrink() {
  let [loaderVal,setLoaderVal]=useState(false)
    ...
    async function searchByLettetr()
    {
      setLoaderVal(true)
...
<h2 className='text-center mt-2 text-white'><span className='text-danger text-capitalize'>The Expected Drink For you</span> </h2>
...
{/* <h3 className='text-warning text-center'>Nothing</h3> */}
    ...
    {fromSearchItems!=[]&&fromSearchItems!=null?fromSearchItems?.map(el=>{
        ...
        <div    className={fromSearchItems.length==1?"col-lg-6":fromSearchItems.length==2?"col-lg-6":"col-sm-6 col-lg-4"}>
