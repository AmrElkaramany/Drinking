...
import comeSoon from "../../assests/comeSoon.avif"
import { Helmet } from 'react-helmet';


export default function LetterSelcted() {
  ...
  let [loaderVal,setLoaderVal]=useState(false)
    ...
    async function searchByLettetr(letterParameter)
    {
      setLoaderVal(true)


        let {data} =await axios.get(`https://www.thecocktaildb.com/api/json/v1/1/search.php?f=${letterParameter}`)
...
<h2 className='text-center mt-2 text-white'>Drinks Contains <span className='text-danger'>( {letter} )</span> Letter</h2>
...
{/* <h3 className='text-warning text-center'>Nothing</h3> */}
    ...
    <div className="row g-4 justify-content-center">
        ...
        {/* <h3 className='text-center'>  <span className='text-danger'>Related <span className='text-white'>Drinks</span></span> </h3> */}
    ...
    <p className='alert alert-danger fs-4 text-center'>No Results</p>

<img src={comeSoon} className='w-100' alt="" />
