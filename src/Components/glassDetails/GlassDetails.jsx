  ...
  let [loaderVal,setLoaderVal]=useState(false)
    ...
    async function getSelctedGlass(productNameParameter)
    {
      setLoaderVal(true)
        ...
        let {data}=await axios.get(`https://www.thecocktaildb.com/api/json/v1/1/filter.php?g=${productNameParameter}`)
...
<h3 className='my-5 text-center '>( Ingradiants )</h3>
  ...
  {el.strIngredient1!=""&&el.strIngredient1!=null?
            ...
            <>
                      ...
                      <h3 className='my-5 text-center '>Related Drinks in ( {GlassName} ) Category</h3>
...
{/* <h3 className='text-warning text-center'>Nothing</h3> */}
    ...
    <div className="row g-4 justify-content-center">
        <h3 className='text-center'>  <span className='text-danger'>( {GlassName} ) <span className='text-white'>Drinks</span></span> </h3>
