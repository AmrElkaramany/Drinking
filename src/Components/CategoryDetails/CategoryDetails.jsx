...
export default function CategoryDetails() {
  ...
  let [loaderVal,setLoaderVal]=useState(false)
    ...
    let [categegoryItems,setCategoryItems]=useState([])
    ...
    // details of clicked category item
...
var settings = {
  ...
  responsive: [
    ...
    useEffect(()=>{
        ...
        getSelctedCategory(productName)
    ...
    <div className="modal-content bg-black border-0">
      ...
      <div class="modal-body">
        ...
        {DetailsItem!=[]?DetailsItem.map(el=>{
            ...
            <Link className="text-white text-center my-3" to={`/categoriesdetails/${el.strCategory}`}>{el.strCategory}</Link>
  ...
  {el.strIngredient1!=""&&el.strIngredient1!=null?
          ...
          <div  className='bg-white w-75 p-1 mt-5 rounded-pill'></div>
              ...
              <div className="row overflow-hidden">
                ...
                <h3 className='my-5 text-center '>Related Drinks in ( {productName} ) Category</h3>

              <Slider {...settings}>

{categegoryItems?categegoryItems.map((el)=>{
...
{/* before modal */}
  <div className="container">
    <div className="row g-4 justify-content-center">
        <h3 className='text-center'><span className='text-danger'>({productName=="Other"?"Fizz":productName=="Coffee"?"Coffee / Tea":productName=="Punch"?"Punch / Party Drink":productName})</span>  <span className='text-white'>Drinks</span></h3>
